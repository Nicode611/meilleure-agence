        ...
        <div className="bg-white rounded-2xl shadow-soft p-8 md:p-12">
          ...
          <section className="mb-12">
            ...
            <div className="prose prose-lg text-gray-700">
              <p><strong>IMMO-9 / Xpert IMMO SRL</strong></p>
          ...
          <section className="mb-12">
            ...
            <div className="prose prose-lg text-gray-700 space-y-4">
              <p><strong>IMMO-9</strong> a ouvert ce site pour l’information personnelle de ses utilisateurs. Aucune exploitation commerciale, même partielle, des données qui y sont présentées ne pourra être effectuée sans l’accord préalable et écrit de <strong>IMMO-9</strong>.</p>
              <p><strong>IMMO-9</strong> avise les utilisateurs de ce site que les éléments de ce site&nbsp;:</p>
              <ul>
          ...
          <section className="mb-12">
            ...
            <div className="prose prose-lg text-gray-700 space-y-4">
              <p>Il est possible de créer un lien vers ce site sans autorisation expresse de l’éditeur, à la seule condition que ce lien ouvre une nouvelle fenêtre du navigateur. Toutefois, <strong>IMMO-9</strong> se réserve le droit de demander la suppression d’un lien qu’il estime non conforme à sa politique éditoriale.</p>
              <p>Dans les autres cas et notamment :</p>
              <ul>
                <li>si vous souhaitez afficher les logos, marques et/ou créations de <strong>IMMO-9</strong> ;</li>
                <li>si le contenu du site <a href="http://www.immo-9.com" target="_blank" rel="noopener noreferrer">www.immo-9.com</a> doit s’intégrer dans la navigation de votre site (ex. : cadres/frames) ;</li>
                <li>si l’accès aux pages contenant le lien vers le site <a href="http://www.immo-9.com" target="_blank" rel="noopener noreferrer">www.immo-9.com</a> n’est pas gratuit,</li>
              </ul>
              <p>vous devez demander l’autorisation expresse de <strong>IMMO-9</strong> à l’adresse mentionnée au point « Éditeur du site / Direction de la publication ». La libre autorisation de faire un lien n’inclut pas le droit à la reproduction d’une partie du contenu du site pour fabriquer ce lien.</p>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="prose prose-lg text-gray-700 space-y-4">
              <p><strong>Politique IMMO-9</strong> de protection des données personnelles collectées sur Internet : <strong>IMMO-9</strong> met tout en œuvre pour protéger les données personnelles des visiteurs de ce site dans le respect de la législation sur la protection des données à caractère personnel.</p>
              <p><strong>Types d’informations collectées et utilisation</strong> : <strong>IMMO-9</strong> collecte uniquement les données personnelles (nom, prénom, adresses postale et électronique) que vous soumettez volontairement (ex. : demande d’informations, avis sur nos sites/produits). A chaque collecte, les finalités et modalités de traitement sont clairement exposées.</p>
              <p><strong>Partage des données personnelles</strong> : des informations de nature commerciale peuvent être envoyées avec votre autorisation. <strong>IMMO-9</strong> peut recourir à des prestataires (exécution de commandes, assistance promotionnelle, services techniques). Ces entreprises peuvent accéder aux données personnelles si nécessaire pour leurs tâches et s’engagent à respecter la législation applicable. Elles ne peuvent utiliser ces données qu’aux seules fins d’exécuter leurs missions. <strong>IMMO-9</strong> ne vend, ne cède et ne communique aucune donnée personnelle à des tiers.</p>
              <p>Si vous souhaitez recevoir de la documentation commerciale provenant de partenaires, <strong>IMMO-9</strong> ne partagera pas vos données ; un lien ou un moyen de contact pourra vous être communiqué pour accéder aux offres des partenaires.</p>
              <p>En cas d’obligation légale, administrative ou judiciaire de communication à un tiers autorisé, <strong>IMMO-9</strong> s’engage, préalablement à toute communication, à en informer les personnes concernées.</p>
          ...
          <section className="mb-12">
            ...
            <div className="prose prose-lg text-gray-700">
              <p>Conformément à la loi, <strong>IMMO-9</strong> met en œuvre toutes les précautions de sécurité nécessaires au respect de la confidentialité des données personnelles.</p>
            </div>
          </section>
